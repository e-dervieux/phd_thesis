...
\newcommand*{\mbookcite}[4]{
\begin{center}
		\begin{minipage}[b]{0.083\textwidth}
			\reflectbox{\includegraphics[width=\textwidth]{0_front_matter/front_figures/tentacle.pdf}}\vspace{0.cm}
		\end{minipage}
		...
		\end{minipage}
		\begin{minipage}[b]{0.083\textwidth}
			\strut\vspace*{-\baselineskip}\newline\includegraphics[width=\textwidth]{0_front_matter/front_figures/tentacle.pdf}\vspace{0.cm}
		\end{minipage}
\end{center}}
