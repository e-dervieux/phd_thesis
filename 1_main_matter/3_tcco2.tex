...
\begin{equation}
	...
	\end{aligned}
\end{equation}
wherein $R$ is the ideal gas constant (J.K$^{-1}$.mol$^{-1}$), T the temperature (K) and $K_s$ is the solubility of \gls{co2} in water (mol.m$^{-3}$.Pa$^{-1}$)---as reported by Weiss\cite{weiss1974}, for instance. Combining the above equations yields
\begin{equation}
