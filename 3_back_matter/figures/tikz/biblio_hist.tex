...
\begin{document}
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\draw[draw=black,fill=blue] (axis cs:1966,0) rectangle (axis cs:1968,4);
			\draw[draw=black,fill=blue] (axis cs:1968,0) rectangle (axis cs:1970,3);
			\draw[draw=black,fill=blue] (axis cs:1970,0) rectangle (axis cs:1972,5);
			\draw[draw=black,fill=blue] (axis cs:1972,0) rectangle (axis cs:1974,7);
			...
			\draw[draw=black,fill=blue] (axis cs:1980,0) rectangle (axis cs:1982,21);
			...
			\draw[draw=black,fill=blue] (axis cs:1988,0) rectangle (axis cs:1990,16);
			\draw[draw=black,fill=blue] (axis cs:1990,0) rectangle (axis cs:1992,17);
			\draw[draw=black,fill=blue] (axis cs:1992,0) rectangle (axis cs:1994,17);
			\draw[draw=black,fill=blue] (axis cs:1994,0) rectangle (axis cs:1996,23);
			\draw[draw=black,fill=blue] (axis cs:1996,0) rectangle (axis cs:1998,26);
			\draw[draw=black,fill=blue] (axis cs:1998,0) rectangle (axis cs:2000,24);
			...
			\draw[draw=black,fill=blue] (axis cs:2004,0) rectangle (axis cs:2006,33);
			\draw[draw=black,fill=blue] (axis cs:2006,0) rectangle (axis cs:2008,41);
			\draw[draw=black,fill=blue] (axis cs:2008,0) rectangle (axis cs:2010,33);
			\draw[draw=black,fill=blue] (axis cs:2010,0) rectangle (axis cs:2012,48);
			\draw[draw=black,fill=blue] (axis cs:2012,0) rectangle (axis cs:2014,51);
			\draw[draw=black,fill=blue] (axis cs:2014,0) rectangle (axis cs:2016,62);
			\draw[draw=black,fill=blue] (axis cs:2016,0) rectangle (axis cs:2018,54);
			\draw[draw=black,fill=blue] (axis cs:2018,0) rectangle (axis cs:2020,66);
			\draw[draw=black,fill=blue] (axis cs:2020,0) rectangle (axis cs:2022,52);
			\draw[draw=black,fill=blue] (axis cs:2022,0) rectangle (axis cs:2024,64);
		\end{axis}
