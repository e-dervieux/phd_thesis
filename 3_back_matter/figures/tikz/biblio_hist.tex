...
\begin{document}
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\draw[draw=black,fill=red] (axis cs:1898,0) rectangle (axis cs:1900,7);
			...
			\draw[draw=black,fill=blue] (axis cs:2008,0) rectangle (axis cs:2010,38);
			\draw[draw=black,fill=blue] (axis cs:2010,0) rectangle (axis cs:2012,50);
			...
			\draw[draw=black,fill=blue] (axis cs:2022,0) rectangle (axis cs:2024,66);
		\end{axis}
